package kg.bitruby.bybitintegratorservice.common.config;
...
public class SchemaInitConfig {
  ...
  public static class SchemaInitBean implements InitializingBean {
    ...
    @Autowired
    public SchemaInitBean(DataSource dataSource, @Value("${bitruby.bybit-integrator-service.db.schema}") String schemaName) {
    ...
    public void afterPropertiesSet() {
      try (Connection conn = dataSource.getConnection();
        ...
        throw new BitrubyRuntimeExpection("Failed to create schema '" + schemaName + "'", e);
      }
    }
  }
  ...
  static class SpringLiquibaseDependsOnPostProcessor extends
