package kg.bitruby.authservice.config;
...
import kg.bitruby.authservice.config.granttypes.email_password.EmailPasswordAuthenticationConverter;
import kg.bitruby.authservice.config.granttypes.email_password.EmailPasswordAuthenticationProvider;
import kg.bitruby.authservice.config.granttypes.email_password.EmailPasswordAuthenticationToken;
import kg.bitruby.authservice.config.granttypes.phone_password.PhonePasswordAuthenticationConverter;
